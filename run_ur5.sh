...
for ((i=0; i<$repeats; i++)); do
    ...
    python task_ur5_visual_reacher.py --algorithm 'rad' --work_dir "/home/gautham/madi/results" --camera_id 0 --description "eval_madi" --seed $current_seed  --init_steps 1000 --device "cuda:0" --save_mask --strong_augment 'conv'
done
